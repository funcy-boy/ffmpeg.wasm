...
export interface FFMessageLoadConfig {
   ...
   * `ffmpeg-core.js` URL.
   *
   * @defaultValue `https://cdn.jsdelivr.net/npm/@ezwebtools/ffmpeg-core@${CORE_VERSION}/dist/umd/ffmpeg-core.js`;
   */
  coreURL?: string;
  /**
   * `ffmpeg-core.wasm` URL.
   *
   * @defaultValue `https://cdn.jsdelivr.net/npm/@ezwebtools/ffmpeg-core@${CORE_VERSION}/dist/umd/ffmpeg-core.wasm`;
   */
  wasmURL?: string;
  /**
   ...
   * @defaultValue `https://cdn.jsdelivr.net/npm/@ezwebtools/ffmpeg-core-mt@${CORE_VERSION}/dist/umd/ffmpeg-core.worker.js`;
   */
  workerURL?: string;
  /**
